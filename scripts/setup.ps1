...
if (-not $Node -or -not $Npm) { throw 'Node.js LTS and npm are required. Install them from https://nodejs.org/.' }
...
Write-Host ''
Write-Host 'Setup complete. Trust the local CA on this Windows user and each phone, then start the TV controller with .\scripts\start.ps1'
